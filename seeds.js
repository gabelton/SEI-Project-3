  ...
  db.dropDatabase()
    ...
    .then(() => {
      return Vinyl.create([{
        ...
        condition: 'Mint',
        length: '42:13',
        notes: 'Post Pop Depression is the seventeenth studio album by American rock singer Iggy Pop, released by Loma Vista Recordings on March 18, 2016. Produced by Josh Homme of Queens of the Stone Age, the album was recorded in secrecy and features Queens of the Stone Age member Dean Fertita and Arctic Monkeys drummer Matt Helders.',
        label: 'Loma Vista',
        size: '12"',
        format: '2LP',
        speed: '45 RPM',
